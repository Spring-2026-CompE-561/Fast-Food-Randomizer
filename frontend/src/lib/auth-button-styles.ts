/** Primary CTA lift — Randomizer-style pop (navbar Sign Up, auth form submits). */
export const authPopPrimary =
  "group border border-transparent shadow-lg shadow-primary/25 transition-all duration-300 ease-out hover:scale-[1.025] hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/40 hover:border-primary-foreground/25 active:scale-[0.98] active:translate-y-0 disabled:hover:scale-100 disabled:hover:translate-y-0 disabled:hover:shadow-lg disabled:hover:border-transparent";
...
/** Pill/chip lift — same motion as Login / Sign Up for filter dialogs and toggles. */
...
/** Dietary chips — accent-colored hover shadow to match selected accent styling. */
